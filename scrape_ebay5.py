...
if __name__ == '__main__':
    ...
    ebay_urls = [
        'https://www.ebay.com/sch/i.html?_from=R40&_nkw=laptop&_sacat=177&_fcid=1&_sop=15&rt=nc&LH_ItemCondition=1000%7C2010&Type=Notebook%252FLaptop&_dcat=177&_ipg=240&_pgn=5',
    ]
    ...
    if scraped_data:
        ...
        save_to_csv(scraped_data, f'page/ebay_data_5.csv')
        print(f"Data berhasil disimpan dalam file ebay_data_5.csv")
    else:
